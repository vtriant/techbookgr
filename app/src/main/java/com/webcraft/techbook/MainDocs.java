...
public class MainDocs extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {


    public TextView mycontent, mycontent2;
    public String token;
    public String date_simiosis,simiosi,giamathiti3;
        ...
        if (InternetStatus.getInstance(this).isOnline()) {
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    new GetMethodDemo().execute("https://techbook.pythonanywhere.com/simiosis/");
            ...
            try {
                ...
                if(aryJSONStrings !=null ) {
                    ...
                    for (int i = 0; i < aryJSONStrings.length(); i++) {
                        try {
                            simiosi = aryJSONStrings.getJSONObject(i).getString("simiosi");
                        }
                        catch (JSONException ignored) {}
                        try {
                            date_simiosis = aryJSONStrings.getJSONObject(i).getString("date_simiosis");
                        ...
                        try {
                            giamathiti3 = aryJSONStrings.getJSONObject(i).getString("giamathiti3");
                        ...
                        if (date_simiosis != null) {

                            if (giamathiti3.equals("sae")){
                                mylist.add("Σημείωση για ΣΥΣΤΗΜΑΤΑ ΑΥΤΟΚΙΝΗΤΟΥ " + date_simiosis);}
                            if (giamathiti3.equals("psiksi")){ mylist.add("Σημείωση για ΨΥΞΗ ΚΑΙ ΚΛΙΜΑΤΙΣΜΟΣ " + date_simiosis);}
                            if (giamathiti3.equals("ergaliomihanes")){ mylist.add("Σημείωση για ΕΡΓΑΛΕΙΟΜΗΧΑΝΕΣ " + date_simiosis);}
                    ...
                    ArrayAdapter adapter = new ArrayAdapter<String>(MainDocs.this, R.layout.listad, R.id.textview, combined);
